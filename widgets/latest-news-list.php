...
class Appostli_Retro_List_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'appostli_retro_list';
    }

    public function get_title() {
        return __( 'Retro News Grid', 'appostli' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __( 'Query Settings', 'appostli' ),
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __( 'Posts Per Page', 'appostli' ),
    ...
    protected function render() {
        ...
        // If used on a category/author template, inherit the current context
